                        ...
                        <div class="form-spacing">
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <?php if (isset($_SESSION['createcl'])) {
                                    ?>
                                        <div class="alert alert-success left-icon-alert" role="alert" id="alert">
                                            <strong>Well done!</strong> <?php echo $_SESSION['createcl']; ?>
                                        </div>
                                    <?php
                                        unset($_SESSION['createcl']);
                                    } ?>
                                    ...
                                    <form class="form-horizontal" method="post" action="./Functions/add_function.php">
                                        ...
                                        <div class="form-group has-success">
                                            <label for="success" class="control-label">School Year</label>
                                            <div class="">
                                                <div class="row">
                                                    <div class="col-4">
                                                        <select name="yeara" id="year" class="form-control">
                                                            <?php
                                                            for ($i = 0; $i <= 20; ++$i) {
                                                                ...
                                                                if ((isset($_GET['year'])) && ($value == $_GET['year'])) echo 'selected';
                                                                echo '>' . strtoupper($label) . '</option>';
                                                            }
                                                    ...
                                                    –
                                                    <div class="col-4">
                                                        <select name="yearb" id="year" class="form-control">
                                                            <?php
                                                            for ($i = 0; $i <= 20; ++$i) {
                                                                $time = strtotime(sprintf('+%d years', $i));
                                                                $label = date('Y', $time);
                                        ...
                                        <div class="form-group has-success">
                                            <div class="">
                                                <button type="submit" name="createcl" class="btn btn-success btn-labeled">Submit<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                            </div>
                                        </div>
