    ...
    ////////////////////////////////////////////////////// -->
        <main class="mt-5 pt-3">
            ...
            <section>
                ...
                ?>
                    <div class="alert alert-success left-icon-alert" role="alert" id="sub">
                        <strong>Well done!</strong> <?php echo $_SESSION['sub']; ?>
                    </div>
                <?php
                    unset($_SESSION['sub']);
                } ?>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <span><i class="bi bi-table me-2"></i></span> List of Subjects
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="table hover data-table" style="width: 100%">
                                            ...
                                            <tbody>
                                                <?php $sql = "SELECT srms_tblsubject.SubjectDescription, srms_tblsubject.SubjectCode, srms_tblsubject.Units, srms_tblsubject.sub_id from srms_tblsubject";
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) {   ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($result->SubjectDescription); ?></td>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="./polisher/edit-subjects.php?sub_id=<?php echo htmlentities($result->sub_id); ?> "><button type="button" class="btn btn-primary">Edit</button></a>
