                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" method="post" action="./Functions/add_function.php">
                                        <div class="form-group ">
                                            ...
                                            <div class="">
                                                <input type="text" name="subjectdescription" class="form-control" id="default" placeholder="Subject Name" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" name="createsub" class="btn btn-primary">Submit</button>
                                            </div>
                                        </div>
                                    </form>
