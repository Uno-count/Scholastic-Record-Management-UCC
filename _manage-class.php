                        ...
                        <div class="col-md-12 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <span><i class="bi bi-table me-2"></i></span> Manage Classes
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="table hover data-table" style="width: 100%">
                                            ...
                                            <tbody>
                                                <?php $sql = "SELECT srms_tblclasses.class_id, srms_tblclasses.Course, srms_tblclasses.Year, srms_tblclasses.Section from srms_tblclasses";
                                                    ...
                                                    foreach ($results as $result) {   ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="polisher/edit-class.php?class_id=<?php echo htmlentities($result->class_id); ?>"> <button type="button" class="btn btn-primary">Edit</button></a>
                                                                &nbsp;
                                                                &nbsp;
                                                                <a href="views/view_stud.php?class_id=<?php echo htmlentities($result->class_id); ?> "><button type="button" class="btn btn-success">View List</button></a>
