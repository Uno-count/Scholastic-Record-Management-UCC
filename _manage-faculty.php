                        ...
                        <div class="col-md-12 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <span><i class="bi bi-table me-2"></i></span> List of Faculties
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="table hover data-table" style="width: 100%">
                                            ...
                                            <tbody>
                                                <?php $sql = "SELECT srms_tbldepartment.dept_id, srms_tbldepartment.Department from srms_tbldepartment";
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) {   ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?php echo htmlentities($result->Department); ?></td>
                                                            <td class="text-center">



                                                                <a href="views/view_prof.php?dept_id=<?php echo htmlentities($result->dept_id); ?>  "><button type="button" class="btn btn-success">View List</button></a>
