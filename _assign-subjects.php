                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="table hover data-table" style="width: 100%">
                                            ...
                                            <tbody>
                                                <?php $sql = "SELECT srms_tblsubject.SubjectDescription, srms_tblsubject.SubjectCode, srms_tblsubject.Units from srms_tblsubject";
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) {   ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="edit-class.php?classid=<?php echo htmlentities($result->id); ?>"><i class="bi bi-pencil-square"></i> </a>
