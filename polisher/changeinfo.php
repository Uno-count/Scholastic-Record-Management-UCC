                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="form-spacing">
                            ...
                            <?php if (isset($_SESSION['changcoor'])) {
                            ?>
                                <div class="alert alert-success left-icon-alert" role="alert" id="alert">
                                    <strong>Well done!</strong> <?php echo $_SESSION['changcoor']; ?>
                                </div>
                            <?php
                                unset($_SESSION['changcoor']);
                            } ?>

                            <div class="panel">
                                <div class="panel-heading ">
                                    <div class="panel-title spacing">
                                        <h5>Update Username/Password</h5>
                                ...
                                <form method="post" action="../Functions/update_function.php">
                                    <div class="form-group ">
                                        ...
                                        <div class="">
                                            <input type="text" name="username" class="form-control" id="default" placeholder="Subject Name" required="required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="default" class="col-sm-2 control-label">Password</label>
                                        <div class="">
                                            <input type="text" name="password" class="form-control" id="default" placeholder="Subject Code" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input value="<?php if (isset($_SESSION['uname'])) {
                                                                echo $_SESSION['uname'][2]; //firstname
                                                            }
                                                            ?>" name="coorid" type="hidden" class="form-control ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group has-success">
                                        <div class="">
                                            <button type="submit" name="updateinfo" class="btn btn-success btn-labeled">Update<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                        </div>
                                    </div>
