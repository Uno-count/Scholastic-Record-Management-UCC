        ...
        <main class="mt-5 pt-3">
            ...
            <div style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="row breadcrumb-div">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Subject Combination</li>
                </ol>
            </div>
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="row g-3 form-group" method="post" action="../Functions/update_function.php">
                                                ...
                                                <select name="class" class="form-control" id="default" required="required">
                                                    ...
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $result) {   ?>
                                                            <option value="<?php echo htmlentities($result->class_id); ?>"> <?php echo htmlentities($result->Course); ?> (<?php echo htmlentities($result->Year); ?> - <?php echo htmlentities($result->Section); ?>)</option>
                                                    <?php }
                                                    } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group has-success">
                                            <label for="success" class="control-label">Subjects</label>
                                            <div class="">
                                                <select name="subject" class="form-control" id="default" required="required">
                                                    <option value="">Select Subject</option>
                                                    <?php $sql = "SELECT * from srms_tblsubject";
                                                    $query = $dbh->prepare($sql);
                                                    $query->execute();
                                                    $results = $query->fetchAll(PDO::FETCH_OBJ);
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $result) {   ?>
                                                            <option value="<?php echo htmlentities($result->sub_id); ?>"><?php echo htmlentities($result->SubjectDescription); ?> &nbsp;-<?php echo htmlentities($result->SubjectCode); ?></option>
                                                    <?php }
                                                    } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group has-success">
                                            <label for="success" class="control-label">Assign Professor</label>
                                            <div class="">
                                                <select name="assprof" class="form-control" id="default" required="required">
                                                    <option value="">--Select Professor--</option>
                                                    <?php $sql = "SELECT * from srms_tblprof";
                                                    $query = $dbh->prepare($sql);
                                                    $query->execute();
                                                    $results = $query->fetchAll(PDO::FETCH_OBJ);
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $result) {   ?>
                                                            <option value="<?php echo htmlentities($result->prof_id); ?>">&nbsp;<?php echo htmlentities($result->Fullname); ?></option>
                                                    <?php }
                                                    } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <div class="">
                                                <select name="sem" class="form-control" id="default" required="required">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input value="<?php echo  $combi_id = intval($_GET['combi_id']); ?>" name="combiid" type="hidden" class="form-control ">
                                        </div>
                                        ...
                                        <div class="form-group has-success">
                                            <div class="">
                                                <button type="submit" name="combi" class="btn btn-success btn-labeled">Update<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                            </div>
                                        </div>
