                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="form-spacing">
                            ...
                            <?php
                            $cid = intval($_GET['sub_id']);
                            $sql = "SELECT * from srms_tblsubject where sub_id=:cid";
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading ">
                                            <div class="panel-title spacing">
                                                ...
                                                <h3><?php echo htmlentities($result->SubjectDescription); ?> (<?php echo htmlentities($result->SubjectCode); ?>)</h3>
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form class="row g-3 form-group" method="post" action="../Functions/update_function.php">
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Subject Description</label>
                                                    <div class="">
                                                        <input type="text" name="subjectdescription" class="form-control" id="default" placeholder="Subject Description" required="required">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Number of Units</label>
                                                    <div class="">
                                                        <input type="number" name="units" required="required" class="form-control" id="success" placeholder="Eg. 1, 2, 3">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group has-success">
                                            <div class="">
                                                <button type="submit" name="esub" class="btn btn-success btn-labeled">Update<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                            </div>
                                        </div>

                                        <div class="col-6">

                                            <input value="<?php echo  $sub_id = intval($_GET['sub_id']); ?>" name="subid" type="hidden" class="form-control ">
                                        </div>
