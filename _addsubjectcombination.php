                        ...
                        <div class="form-spacing">
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <?php if (isset($_SESSION['combi'])) {
                                    ?>
                                        <div class="alert alert-success left-icon-alert" role="alert" id="alert">
                                            <strong>Well done!</strong> <?php echo $_SESSION['combi']; ?>
                                        </div>
                                    <?php
                                        unset($_SESSION['combi']);
                                    } ?>
                                    ...
                                    <form class="form-horizontal" method="post" action="./Functions/add_function.php">
                                        ...
                                        <div class="form-group has-success">
                                            <div class="">
                                                <button type="submit" name="addcombi" class="btn btn-success btn-labeled">Submit<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                            </div>
                                        </div>
