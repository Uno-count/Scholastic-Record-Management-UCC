                        ...
                        <div class="col-md-12 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h1>
                                        <?php
                                        $dpid = intval($_GET['dept_id']);
                                        $sql = "SELECT * from srms_tbldepartment where dept_id=:dpid";
                                        ...
                                        <table id="example" class="table hover data-table" style="width: 100%">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center">Data of Birth</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $dpid = intval($_GET['dept_id']);
                                                $sql = "SELECT * from srms_tblprof where Department=:dpid";
                                                $query = $dbh->prepare($sql);
                                                $query->bindParam(':dpid', $dpid, PDO::PARAM_STR);
                                                $query->execute();
                                                $results = $query->fetchAll(PDO::FETCH_OBJ);
                                                ...
                                                ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?php echo htmlentities($result->Fullname); ?> <?php echo htmlentities($result->middlename); ?> <?php echo htmlentities($result->lastname); ?></td>
                                                            <td class="text-center"><?php echo htmlentities($result->Email); ?></td>
                                                            <td class="text-center"><?php echo htmlentities($result->No); ?></td>
                                                            <td class="text-center"><?php echo htmlentities($result->DOB); ?></td>
                                                            <td class="text-center"><?php echo htmlentities($result->Spec); ?></td>
