        ...
        <main class="mt-5 pt-3">
            ...
            <div style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="row breadcrumb-div">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Manage Subject Combination</li>
                </ol>
            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <span><i class="bi bi-table me-2"></i></span> Curriculums
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="table hover data-table" style="width: 100%">
                                            ...
                                            <tbody>
                                                <?php $sql = "SELECT * FROM `srms_tblmanagesubcombi` 
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) {   ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?php echo htmlentities($result->Course); ?></td>
                                                            <td class="text-center"><?php echo htmlentities($result->Year); ?></td>
                                                            <td class="text-center"><?php echo htmlentities($result->Section); ?></td>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="polisher/edit-subcombination.php?combi_id=<?php echo htmlentities($result->combi_id); ?>"> <i class=" bi bi-pencil-square"></i></a>
                                                                &nbsp;
                                                                &nbsp;

                                                                <a href="views/view_combi.php?combi_id=<?php echo htmlentities($result->combi_id); ?>"><i class="bi bi-person-lines-fill"></i></a>
