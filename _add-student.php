                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="row g-3 form-group" method="post" action="./Functions/add_function.php">

                                            <div class="col-md-6">
                                                <label for="inputfname" class="form-label">First Name</label>
                                                <input name="firstname" type="input" class="form-control" id="inputfname" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="inputmiddlename" class="form-label">Middle Name</label>
                                                <input name="middlename" type="input" class="form-control" id="inputmiddlename" required>
                                            </div>
                                            <div class="col-md-8">
                                                <label for="inputlastname" class="form-label">Last Name</label>
                                                <input name="lastname" type="input" class="form-control" id="inputlastname">
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input name="studentsnumber" type="number" class="form-control" id="inputstudentnum">
                                            </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input name="email" type="text" class="form-control" id="inputEmail" placeholder="juan@gmail.com">
                                            </div>
                                            <div class="col-6">
                                                <label for="inputnum" class="form-label">Contact Number</label>
                                                <input name="contactnum" type="text" class="form-control" id="inputnum" placeholder="093788...">
                                            </div>



                                            <div class="col-12">
                                                <button name="addstud" type="submit" class="btn btn-primary">Add</button>
                                            </div>
                                        </form>
